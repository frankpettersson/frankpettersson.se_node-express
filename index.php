...
<body>
    <div id="bg">
        <iframe src="projects/graphics/js_canvas/faded_bubbles/" frameborder="0" scrolling="no"></iframe>
    </div>
    <div id="wrapwrap" width="100%" height="100%">
        ...
        <div id="wrap">
            <div class="box iframe">
                <iframe id="frontframe" src="projects/graphics/three.js/3Dspheres_BG/" frameborder="0" scrolling="no"></iframe>
            </div>
            ...
            <div class="box" id="projects">
                ...
                <div class="category">
                    ...
                    <div class="grid hide">
                        <div class="project">
                            <a href="projects/games/idle/idle_0.4_no_jquery/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/idle.webp" alt="idle game plain javascript">
                            </a>
                            <p>Idle game</p>
                        </div>
                        <div class="project">
                            <a href="projects/games/idle/idle_0.3_jquery/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/idle.webp" alt="idle game jquery">
                            </a>
                            <p>Idle game, jQuery</p>
                        </div>
                        <div class="project">
                            <a href="projects/games/units_create_units/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/units_creating_units.webp" alt="units creating units">
                            </a>
                            <p>Units</p>
                        </div>
                    </div>
                ...
                <div class="category">
                    ...
                    <div class="grid hide">
                        <div class="project">
                            <a href="projects/graphics/pixi_js/rotatingRectangle/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/rotating_rectangle.webp" alt="rotating rectangle">
                            </a>
                            <p>Rectangle</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/pixi_js/rotatingPolygons/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/rotating_polygon.webp" alt="rotating polygon">
                            </a>
                            <p>Polygon</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/pixi_js/randomPolygonPositions/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/random_polygons.webp" alt="random polygons">
                            </a>
                            <p>Random polygon</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/paper.js/bubbles/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/bubbles_paper.webp" alt="bubbles paper.js">
                            </a>
                            <p>Bubbles, 400x400</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/paper.js/pixelGrid_blurry/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/pixels_blurry.webp" alt="blurry pixels">
                            </a>
                            <p>Blurry pixels</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/paper.js/pixelGrid_clear/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/pixels_clear.webp" alt="clear pixels">
                            </a>
                            <p>Clear pixels</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/paper.js/langtonsAttempt/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/langton_attempt.webp" alt="langtons ant attempt">
                            </a>
                            <p>Langton's failiure</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/paper.js/langtonsAnt/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/langtons_ant.webp" alt="langtons ant">
                            </a>
                            <p>Langton's ant</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/three.js/3Dspheres/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/spheres.webp" alt="3d spheres with camera controls">
                            </a>
                            <p>3D Shapes</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/three.js/3Dspheres_BG/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/sphere_BG.webp" alt="3d spheres static camera">
                            </a>
                            <p>3D Shapes, BG</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/colours/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/colours.webp" alt="colour canvas">
                            </a>
                            <p>Colours spinning</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/black_hole/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/black_hole.webp" alt="black hole">
                            </a>
                            <p>Black hole</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/bubbles/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/bubbles.webp" alt="bubbles">
                            </a>
                            <p>Bubbles, BG</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/faded_bubbles/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/faded_bubbles.webp" alt="faded bubbles">
                            </a>
                            <p>Faded bubbles, BG</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/black_donut/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/black_donut.webp" alt="black donut">
                            </a>
                            <p>Black donut</p>
                        </div>
                        <div class="project">
                            <a href="projects/graphics/js_canvas/look_in_the_middle/" class="thumbnail">
                                <img type="image/png" src="assets/images/thumbnails/look.webp" alt="look in the middle illusion">
                            </a>
                            <p>Point illusion</p>
                        </div>
                    </div>
