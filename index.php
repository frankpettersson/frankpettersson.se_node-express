    ...
    <div id="wrapwrap" width="100%" height="100%">
        ...
        <div id="wrap">
                            ...
                            <li>
                                ...
                                <div class="project" id="paperjs">
                                    ...
                                    <a href="projects/graphics/paper.js/pixelGrid_blurry/">
                                        <div class="thumbnail"><img type="image/png" src="resources/images/thumbnail/pixels_blurry.webp" alt="blurry pixels">
                                        </div>
                                        <p class="projectname">Pixel grid, blurry</p>
                                    </a>
                                    <a href="projects/graphics/paper.js/pixelGrid_clear/">
                                        <div class="thumbnail"><img type="image/png" src="resources/images/thumbnail/pixels_clear.webp" alt="clear pixels">
                                        </div>
                                    ...
                                    <a href="projects/graphics/paper.js/langtonsAnt/">
                                        <div class="thumbnail"><img type="image/png" src="resources/images/thumbnail/langtons_ant.webp" alt="langtons ant">
                                        </div>
                            ...
                            <li>
                                ...
                                <div class="project" id="jscanvas">
                                    ...
                                    <a href="projects/graphics/js_canvas/faded_bubbles/">
                                        <div class="thumbnail"><img type="image/png" src="resources/images/thumbnail/faded_bubbles.webp" alt="faded bubbles">
                                        </div>
                                        <p class="projectname">Faded bubbles</p>
                                    </a>
                                    <a href="projects/graphics/js_canvas/black_donut/">
                                        <div class="thumbnail"><img type="image/png" src="resources/images/thumbnail/black_donut.webp" alt="black donut">
                                        </div>
            ...
            <div class="box" id="backgroundSwap">
                ...
                <ul>
                    <li><a href="#" onclick="backgroundSwap('projects/graphics/js_canvas/faded_bubbles/')">Faded
                            bubbles</a></li>
                    <li><a href="#" onclick="backgroundSwap('projects/graphics/js_canvas/faded_bubbles_dark/')">Faded
                            bubbles, dark</a></li>
                    <li><a href="#" onclick="backgroundSwap('projects/graphics/paper.js/pixelGrid_fullscreen/')">Pixel
                            grid</a></li>
                    <li><a href="#" onclick="backgroundSwap('projects/graphics/three.js/3Dspheres_BG/')">3D spheres</a>
                    </li>
                </ul>
            </div>
