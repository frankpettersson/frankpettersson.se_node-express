...
document.getElementById('darkMode').addEventListener('click', function darkMode() {
    if (state < 3) {
        document.querySelector('iframe').src = 'projects/graphics/js_canvas/faded_bubbles_dark/index.php';
        ...
        for (let i = 0; i < document.querySelectorAll('a.thumbnail').length; i++) {
            ...
            document.querySelectorAll('.thumbnail img')[i].onmouseover = e => e.target.parentElement.style.border = '3px ridge #1bc600';
            document.querySelectorAll('.thumbnail img')[i].onmouseout = e => e.target.parentElement.style.border = '3px ridge #696969';
            document.querySelectorAll('.thumbnail img')[i].onmousedown  = e => e.target.parentElement.style.border = '3px groove #1bc600';
            document.querySelectorAll('.thumbnail img')[i].onmouseup  = e => e.target.parentElement.style.border = '3px ridge #1bc600';
        }
        ...
        document.querySelector('iframe').src = 'projects/graphics/js_canvas/faded_bubbles/index.php';
        for (let i = 0; i < document.querySelectorAll('div.box').length; i++) {
        ...
        for (let i = 0; i < document.querySelectorAll('a.thumbnail').length; i++) {
            ...
            document.querySelectorAll('.thumbnail img')[i].onmouseover = e => e.target.parentElement.style.border = '3px ridge #1bc600';
            document.querySelectorAll('.thumbnail img')[i].onmouseout = e => e.target.parentElement.style.border = '3px ridge #CCCCCC';
            document.querySelectorAll('.thumbnail img')[i].onmousedown  = e => e.target.parentElement.style.border = '3px groove #1bc600';
            document.querySelectorAll('.thumbnail img')[i].onmouseup  = e => e.target.parentElement.style.border = '3px ridge #1bc600';
        }
