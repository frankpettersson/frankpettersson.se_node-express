...
//DEFAULT PROJECT
DEFAULT_PROJECT ? updateDefaultCanvas(DEFAULT_PROJECT, DEFAULT_PROJECT_LABEL, DEFAULT_PROJECT_IMAGE) : updateDefaultCanvas('projects/graphics/js_canvas/flowing_squares/index.html', 'FLOWING SQUARES', '/images/thumbnails/flowing%20squares.png');
...
document.querySelector('#save').addEventListener('click', () => {
    ...
    let newDefaultCanvasImage = '/images/thumbnails/'+document.querySelector('#select-default-project').options[document.querySelector('#select-default-project').selectedIndex].label.toLowerCase()+'.png';
...
document.querySelector('#reset').addEventListener('click', () => {
    ...
    updateDefaultCanvas('projects/graphics/js_canvas/flowing_squares/index.html', 'FLOWING SQUARES', '/images/thumbnails/flowing squares.png');
});
